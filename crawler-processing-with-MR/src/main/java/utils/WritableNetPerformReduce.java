...
public class WritableNetPerformReduce implements Writable {

    private LongWritable numberOfBytes;
    private LongWritable extractionTime;
    private DoubleWritable bandwith;

    public WritableNetPerformReduce() {
        numberOfBytes = new LongWritable(0);
        extractionTime = new LongWritable(0);
        bandwith = new DoubleWritable(0);
    }

    public WritableNetPerformReduce(LongWritable numberOfBytes, LongWritable extractionTime, DoubleWritable bandwith) {
