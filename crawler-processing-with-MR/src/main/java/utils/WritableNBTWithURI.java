...
public class WritableNBTWithURI {
    ...
    public WritableNBTWithURI(LongWritable numberOfBytes, LongWritable extractionTime, DoubleWritable bandwith, Text siteURI) {
    ...
    public WritableNBTWithURI(Text siteURI, WritableNBTReduce nbtReduce) {
