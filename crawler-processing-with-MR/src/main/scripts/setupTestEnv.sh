...
for (( VAR = 1; VAR < 3; ++VAR )); do
    hdfs dfs -cp /tests/input-data/1/sample1.warc.wet /tests/input-data/2/sample$VAR.warc.wet
done
...
for (( VAR = 1; VAR < 33; ++VAR )); do
    hdfs dfs -cp /tests/input-data/1/sample1.warc.wet /tests/input-data/32/sample$VAR.warc.wet
done